...
"}")
        ...
        self.initiateButton = QtWidgets.QPushButton(self.groupBox_2)
        self.initiateButton.setMinimumSize(QtCore.QSize(0, 0))
        self.initiateButton.setMaximumSize(QtCore.QSize(100, 16777215))
        self.initiateButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.initiateButton.setObjectName("initiateButton")
        self.gridLayout_9.addWidget(self.initiateButton,0,0,1,1)
        self.gridLayout_9.addWidget(self.pushButton_18, 0,1, 1, 1)
...
"font: 700 10pt \"Times New Roman\";")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.initiateButton.setText(_translate("MainWindow","Automate"))
